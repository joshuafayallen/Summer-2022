...
FOIA(1967) a federal freedom of information law that requires the full or partial disclosure of previously unreleased information and documents controlled by the United States government upon request 
---
...
- Print Media
  ...
  - The depth and accuracy of sources is given more attention
- Social Media
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/jK2bMrH4ezA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
The FCC requires radio stations to apply for licenses, which are granted only if stations follow rules about limiting advertising, providing a public forum for discussion, and serving local and minority communities. 

Licences are important for practical reasons if you are licensed radio station your station won't have to worry about lots of things. If you turn in 96.5 Koit like my grandma did every morning than it will be the same station everyday. If somebody starts trying to infringe upon Koit's station Koit can file a complaint and then the FCC will just keep adding fines or you are in violation of federal law and you can face forfeiture or even jail time.
...
???
In order to maintain an FCC license you had to follow these rules 
...
so this website and amazon are to be treated equally by the internet service providers and they can't up charge you for going to high traffic websites. Under the Trump administration that had changed.

What does net neutrality mean in practice. This silly little website is not the subject of controversy around net neutrality. Most of us have access to a Netflix account. How many of you have Comcast as your internet provider or have had Comcast as an internet provider in the past? Lets say that Comcast decides to drive people toward their own streaming services they basically slow down the speed to Netflix or other streaming services they do not own. 

Or in some cases streaming services could pay a premium to speed up the delivery of content to you. What does that mean? In practice this would mean that companies like Netflix would be able to afford to pay these prices while a startup like say Netflix 10 years ago would not be able to pay these premiums. You the consumer could actively choose to purchase the slower service but that is not generally how the game theory works out
...
$$
\begin{align}
\overbrace{A}^{\text{Attitude}} = \Sigma\overbrace{V_{i}}^\text{Dimensions used to evaluate something on} \underbrace{W_{i}}_{\text{Weight you give to individual dimensions }}
\end{align}
$$
???
...
think of the frames of reference we talked about in public opinion. This is in effect captured by Vi. 
...
Frames can also play up or down the frequency of an event changing our sort of internal calculations 
...
???
The vertical lines denote presidential elections but the author put them on the exact date so they are slightly off kilter. 
...
???
Because things are complicated the book advises you to be good consumers of the media that don't consume political information for its entertainment value. You should tend toward the boring stuff. So my grandma loves the news especially Maddow. She loves her a lot but thats not always good because Maddow will tend to be very liberal and is more on the editorial side of news. The book and allsides where this graphic comes from argues that you should be up in the high news content side put sample from a range of outlets

I tend to read news articles more often than not and essentially never look at the editorials. The sort of exception to this is monkey cage because it is where a lot of public facing scholarship lies. They tend to just be snapshots of political science articles but in ways that are accessbile to a general public and not just political scientists
---
