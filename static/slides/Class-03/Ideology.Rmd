...
There is a sliding scale of the coordination of labor unions sometimes referred to Coordinated Market Economies. To the area on the far right where there is a much larger social safety net. 
...
We hear a lot of partisanship colloqually but the form it takes has sort of fundamentally change. In the past when political science and others have talked about partisanship they are talking about the policy disagreements that we have. However, much of the research that has been conducted for close to 20 years now shows that increasingly partisianship is a salient political identity. In this case politics becomes a zero sum game where a gain for one side is a loss for the other side. This affects our life in other ways. Partisianship bleeds into our life in various other ways when it becomes a social identity. IN surveys scholars have found results that indicate not only are people less willing to live in a neighborhood that is predominatly made up another party, but people increasingly say that they are less likely to date somebody from the other political party. In some respects you can see this born out in the data but there are likely lots of confounding factor 
