...
pacman::p_load("tidyverse", "patchwork", "ggridges","gameofthrones","viridis", "here", "lubridate", "stevemisc", "xaringanExtra", "flair", "countdown","hrbrthemes","ggthemes", "vembedr", "gtExtras", "gt")
  ...
  ggplot2::theme_minimal() + theme(
    plot.title = element_text( 
      face = "bold", size = 1.285 * base_size, colour = "#454545", hjust = title_hjust,
      # Margins
      margin = ggplot2::margin(b = title_margin, unit = "pt")),
    plot.subtitle = ggplot2::element_text(
      face = "italic", size = .86 * base_size,
      colour = "#454545",
      # Center subtitle
      hjust = title_hjust,
      # Margins
